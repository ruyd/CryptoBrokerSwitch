...
namespace BittrexFx.Classes
{
    public static class List2Html
    {
            ...
            return listOfProperties == null || !listOfProperties.Any()
                ...
                : "<tr>" +
                  listOfProperties.Aggregate(ret,
                      (current, propValue) =>
                          current +
                          ("<th style='font-size: 11pt; font-weight: bold; border: 1pt solid gray'>" +
            ...
            return classObject == null
                ...
                : "<tr>" +
                  classObject.GetType()
                      ...
                      .Aggregate(ret,
                          (current, prop) =>
                              current + ("<td style='font-size: 11pt; font-weight: normal; border: 1pt solid gray'>" +
